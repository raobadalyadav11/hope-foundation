...
const campaignsData = [
  {
    ...
    gallery: ["/event.png?height=300&width=400", "/event.png?height=300&width=400"],
    featured: true,
    isActive: true,
    status: "active",
  ...
  },
  {
    ...
    category: "education",
    image: "/education.png?height=400&width=600",
    gallery: [],
    featured: true,
    isActive: true,
    status: "active",
  ...
  },
  {
    ...
    category: "healthcare",
    image: "/health.png?height=400&width=600",
    gallery: [],
    featured: false,
    isActive: true,
    status: "active",
  ...
  },
  {
    ...
    image: "/women.png?height=400&width=600",
    gallery: [],
    featured: false,
    isActive: true,
    status: "active",
  ...
  },
  {
    ...
    image: "/dis.png?height=400&width=600",
    gallery: [],
    featured: true,
    isActive: true,
    status: "active",
...
const eventsData = [
  ...
  },
  {
    ...
    attendees: [],
    image: "/fund.png?height=300&width=400",
    gallery: [],
    category: "fundraiser",
  ...
  },
  {
    ...
    currentAttendees: 30,
    attendees: [],
    image: "/event.png?height=300&width=400",
    gallery: [],
    category: "training",
...
const blogsData = [
  {
    ...
    featuredImage: "/water.png?height=400&width=600",
  ...
  },
  {
    ...
    featuredImage: "/education.png?height=400&width=600",
  ...
  },
  {
    ...
    featuredImage: "/health.png?height=400&width=600",
  ...
  },
  {
    ...
    featuredImage: "/event.png?height=400&width=600",
